export default function Footer() {
  return (
    <footer className="relative bg-black border-t border-blue-500/20 py-12 sm:py-16 lg:py-20">
      <div className="absolute inset-0 bg-gradient-to-t from-blue-950/20 to-transparent"></div>
      
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
          <div className="sm:col-span-2 lg:col-span-1">
            <h3 className="text-2xl sm:text-3xl font-bold gradient-text mb-4">AI Image</h3>
            <p className="text-slate-400 mb-6 text-sm sm:text-base">Revolutionizing creativity with artificial intelligence.</p>
          ...
          <div>
            <h4 className="text-base sm:text-lg font-semibold text-white mb-4 sm:mb-6">Product</h4>
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3 text-slate-400 text-sm sm:text-base">
              <li><a href="#" className="hover:text-cyan-400 transition-colors">Tutorial</a></li>
        ...
        <div className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-slate-800 text-center">
          <p className="text-slate-400 text-sm sm:text-base">
            © 2025 AI Image. All rights reserved. Powered by cutting-edge AI technology.
          </p>
        </div>
      </div>
    </footer>
